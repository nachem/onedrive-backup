...
async def test_sharepoint_connection():
    ...
    try:
        ...
        site_url = 'your-tenant.sharepoint.com'
        ...
        if response.status_code == 200:
            ...
            search_endpoint = f'https://graph.microsoft.com/v1.0/sites?search=your-tenant'
            ...
            if response.status_code == 200:
                ...
                print(f'   Found {len(found_sites)} sites matching "your-tenant"')
